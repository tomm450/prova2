function [xc,dl,theta_G,cp,xp,yp,A,B,x,b] = HSA_core_lightBU(IN,BU_par,xp1,yp1,xp2,yp2,PLT,k,save_coor)
% HSAfo full output
...
[~,A,B,xc,yc,dl,N,T,x,b] = HS_staz_multi_2(xp,yp,U_inf);
...
%% SUBROUTINE
function [lfun,A,B,xc,yc,dl,N,T,x,b] = HS_staz_multi_2(xp,yp,U_inf)
%questo � giusto
